...
## Humanitats digitals
- Una intersecció (moltes, de fet)
- Mètodes *computacionals*, materials *humanístics*

----

### Alguns exemples
- [Closer to van Eyck](https://closertovaneyck.kikirpa.be/)
- [ArtVis (Univie & TU Wien)](https://artvis.cvast.tuwien.ac.at/)
- [Venice Time Machine (EPFL)](https://youtu.be/uQQGgYPRWfs)
...
Aquesta assignatura és introductòria i panoràmica. No cal tenir coneixements previs sobre informàtica

Combinarem teoria i petits exercicis pràctics. Cal disposar d'un ordinador on s'hi puguin instal·lar programes

----

### Continguts (temptativa)
- Conceptes fonamentals
- Humanitats digitals i Història de l'art
- Dades. Modelat de dades
- Digitalització. Imatge digital
- Bases de dades
- Llenguatges de marques
- Llenguatges de programació
- Recol·lecció, preprocessat i enriquiment de dades
- Anàlisi de dades
...
### Sessions pràctiques (25%)
Durant les sessions de teoria <span style="font-size: 0.5em;">(Qui no hi és, no hi és comptat)</span>

Activitats a entregar via campus virtual

----

### Treball escrit (25%)
Diverses parts:
1. Familiarització amb una eina d'ús freqüent en projectes d'humanitats digitals (què fa, com funciona, qui l'ha dissenyat, què va bé, què es podria millorar, etc.)
2. Petit projecte de confecció d'un corpus, anàlisi i/o visualització de dades que comporti l'ús de l'eina escollida

----

### Presentació (15%)
- De l'eina escollida
- Demostració del seu funcionament (*live demo*)
- Breu explicació sobre el projecte que es vol dur a terme.

----

### Examen (25%)
El dia, hora i sala publicats al calendari d'exàmens de la facultat

Una mica de tot: qüestionari tipus test, preguntes de resposta curta, supòsits pràctics, etc.
...
## Bola extra
- Sobre l'ús d'intel·ligència artificial generativa
- El meu gos se m'ha menjat els deures!
- Compartiràs les diapositives?
- Consultes
	- correu-e (missatges del campus virtual)
	- tutories en persona / videotrucada a demanda
	- dubtes generals al fòrum de l'assignatura
